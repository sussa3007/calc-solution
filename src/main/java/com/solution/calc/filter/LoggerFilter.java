package com.solution.calc.filter;
...
public class LoggerFilter extends OncePerRequestFilter {
    ...
    public void doFilterInternal(
        ...
        if (
                !requestURI.contains("/api/sse") &&
                        !requestURI.contains("/api/deposit/live") &&
                        !requestURI.contains("/api/calc") &&
                        !requestURI.contains("/api/index/data")
        ) {
